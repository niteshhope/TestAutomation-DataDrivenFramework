...
public class TestConfig{
	...
	public static String from = "hynitesh38@gmail.com";
	public static String password = "5121119nitesh";
	public static String[] to ={"hynitesh38@gmail.com","nitesh.hope@gmail.com"};
