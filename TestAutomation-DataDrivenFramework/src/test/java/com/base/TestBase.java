...
public class TestBase {
	...
	/* it act like super or base class 
	 * we need to intitalize the following item 
	 * webdriver 
	 * properties 
	 * logs
	 * Extentreports
	...
	public void select(String locator, String value) {
	 ...
	 public static void verifyEquals(String expected, String actual) throws IOException
	 {
		 try {
			...
			//ReportNG
			 Reporter.log("<br>"+ "Verifciation Failure "+ t.getMessage()+"<br>");
...
@AfterSuite
	public void tesrDown() { // close all thing before test terminate
		if (driver != null) {
			driver.quit();
